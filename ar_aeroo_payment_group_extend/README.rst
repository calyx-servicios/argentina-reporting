======================================
Argentina Payment Aeroo Report Extend
======================================
...
This module extends the functionality of aero payemnt group report and change the template. 
...
Go to app menu and install.
 1.- [l10n_ar_aeroo_payment_group] by ADOH (required).
 2.- [ar_aeroo_payment_group_extend] by Calyx.

Usage
=====

1. Go to payment and print the report.
